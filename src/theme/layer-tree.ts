const layerTreeTheme = {
  slots: {
    ...
    row: 'group/row relative flex w-full cursor-pointer items-center gap-1 rounded-panel border-none bg-transparent py-1.5 pr-1 text-left text-[11px] text-surface hover:bg-hover',
    disclosure:
